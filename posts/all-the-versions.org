...
In [[/channel-changing.html][Channel Changing with Nix]], I described how to move between channels
...
#+BEGIN_SRC shell
$ LC_ALL=C nix run "(import (builtins.fetchurl
"https://matthewbauer.us/generate-versions.nix") {}).emacs.\"24.3\"" -c emacs
#+END_SRC
...
#+BEGIN_SRC shell
$ nix run "(import (builtins.fetchurl
"https://matthewbauer.us/generate-versions.nix") {}).emacs.\"25.3\"" -c emacs
#+END_SRC
...
#+BEGIN_SRC shell
$ LC_ALL=C nix run "(import (builtins.fetchurl
"https://matthewbauer.us/generate-versions.nix") {}).firefox.\"25.0.1\"" -c firefox
#+END_SRC
...
#+BEGIN_SRC shell
$ LC_ALL=C nix run "(import (builtins.fetchurl
"https://matthewbauer.us/generate-versions.nix") {}).blender.\"26.7\"" -c blender
#+END_SRC
