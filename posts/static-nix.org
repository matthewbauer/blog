...
context[fn:1]. To make this even easier, I am publishing prebuilt
=x86_64= binaries on my personal website.
...
$ curl https://matthewbauer.us/nix | \
  ...
  'mplayer $(youtube-dl --no-check-certificate -g https://www.youtube.com/watch?v=dQw4w9WgXcQ)'
#+END_SRC
